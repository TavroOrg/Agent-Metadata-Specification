...
Please refer to the [PDF](/assets/Publications/Agent%20Metadata%20Specification%20V0.2.5.pdf) and [JSON schema](JSON/medical-device-manufacturer-schema.json) for enhancements for the Medical Device industry.
