...
The Agent Metadata Specification seeks to enhance the Google Agent Card to address these additional topics. See the latest [PDF](/assets/Publications/Agent%20Metadata%20Specification%20V0.2.5.pdf) and [JSON schema](schema/v0.2.5/agent-metadata-schema.json).
